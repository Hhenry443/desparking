    ...
    <div class="max-w-4xl mx-auto px-6 pb-20">
        ...
        <div class="space-y-10 text-sm leading-relaxed text-gray-700">
            ...
            <section>
                ...
                <p>
                    These terms form part of the terms and conditions for using the EveryonesParking online service
            ...
            <section>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-900">EveryonesParking's Role</h3>
                        <p>
                            EveryonesParking acts as an agent for the Space Owner to create a binding contract with the Driver when a
                            booking is made. EveryonesParking is not a party to the Parking Contract but may exercise specific rights
                            under it as expressly stated.
                        </p>
                    </div>

                    <div>
                        <h3 class="font-semibold text-gray-900">Relationship to EveryonesParking Terms</h3>
                        <p>
                            By entering into the Parking Contract, both the Driver and the Space Owner agree to comply with the
                            terms and conditions of EveryonesParking's online service in relation to the booking.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p>
                            ...
                            received and accepted by EveryonesParking on behalf of the Space Owner.
                        </p>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <ul class="list-disc pl-6 space-y-2 mt-3">
                            ...
                            <li>Notify EveryonesParking or the Space Owner of any damage to the space during the booking period.</li>
            ...
            <section>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p>The Space Owner is entitled to receive payment for bookings, less EveryonesParking's service fees.</p>
                    </div>
            ...
            <section>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p>
                            EveryonesParking may pursue outstanding payments through legal or debt collection measures, with associated
            ...
            <section>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-900">Cancellation by EveryonesParking or the Space Owner</h3>
                        <p>
                            EveryonesParking or the Space Owner may cancel a booking under certain conditions, such as non-payment by
                            the Driver.
                        </p>
                    </div>
