...
$faqs = [
    ...
    [
        ...
        'answer' => "Once you arrive at the parking space, EveryonesParking and get on with your day!
...
Fees for EveryonesParking

• Listing fees
There is no fee to list a parking space on EveryonesParking.

• Commission
EveryonesParking adds a 19% commission to the price set by the space owner. This commission is transferred to the driver.

• Processing fee
EveryonesParking deducts a 2% processing fee from the space owner’s earnings.

• Service fee
EveryonesParking adds a service fee to the booking total to cover the costs of running the platform. The service fee is between £0.45 and £2.30, and the exact amount is shown at checkout.
...
"
    ...
    [
        ...
        'answer' => "
Yes, the EveryonesParking website is fully secure. We use HTTPS across the entire site to ensure your data is encrypted between your browser and our servers, providing maximum protection for your information.
...
"
    ...
    [
        ...
        'answer' => '
Certainly! Ensuring the safety and security of our customers and their vehicles is our top priority at EveryonesParking. Each of our facilities is outfitted with cutting-edge security systems that include comprehensive surveillance cameras and well-lit surroundings.
